...
class PropertyPublishdManager(models.Manager):
    def get_queryset(self) -> QuerySet:
        return (
            super(PropertyPublishdManager, self)
            .get_queryset()
...
class Property(TimeStampedUUIDModel):
    ...
    country = CountryField(
        verbose_name=_("Country"), default="Korea", blank_label="(select country)"
    )
    city = models.CharField(verbose_name=_("City"), max_length=180, default="Seoul")
    postal_code = models.CharField(
        verbose_name=_("Postal Code"), max_length=100, default="140"
    )
    street_address = models.CharField(
        verbose_name=_("Street Address"), max_length=150, default="Gangnam Daero"
    )
    ...
    photo1 = models.ImageField(default="/interiro_sample.jpg", null=True, blank=True)
    photo2 = models.ImageField(default="/interiro_sample.jpg", null=True, blank=True)
    photo3 = models.ImageField(default="/interiro_sample.jpg", null=True, blank=True)
    photo4 = models.ImageField(default="/interiro_sample.jpg", null=True, blank=True)
    published_status = models.BooleanField(
        verbose_name=_("Published Status"), default=False
    )
    views = models.IntegerField(verbose_name=_("Total Views"), default=0)
    objects = models.Manager()
    published = PropertyPublishdManager()
    ...
    def final_property_price(self):
        ...
        price_after_tax = float(rount(property_price + tax_amount, 2))
